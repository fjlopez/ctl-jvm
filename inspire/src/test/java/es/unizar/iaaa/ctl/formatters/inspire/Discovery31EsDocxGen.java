...
public class Discovery31EsDocxGen {
	
	
	public static void main(String args[]) throws IOException, Docx4JException {
		new Discovery31EsDocxGen().run();
	}

	private void run() throws IOException, Docx4JException {
		WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage();
		MainDocumentPart mainPart = wordMLPackage.getMainDocumentPart();
		File dir = new File("src/test/features/discovery31");
		...
		File out = new File("target/Discovery31EsDocxGen.docx");
