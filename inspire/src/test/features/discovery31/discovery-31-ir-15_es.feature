...
Característica: Requisito 15
  Los servicios de Descubrimiento de terceros deben estar publicados en el Servicio de Descubrimiento
  de un Estado Miembro utilizando la operación de publicación.
  !!!
