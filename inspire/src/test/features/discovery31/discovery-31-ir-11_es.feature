...
Característica: Requisito 11
  El parámetro query debe estar implementado en el por el enunciado filter de la operación GetRecords. 
  La consulta debe soportar todos los atributos definidos en la sección 4.4.
  !!!
