...
Característica: Requisito 5
  Los atributos adicionales de búsqueda listados en la sección 4.4 deben ser 
  publicados en el Metadato de Servicio resultado en la respuesta de un 
  Servicio de Descubrimiento INSPIRE.
  !!!
