...
Feature: Requirement 10
  An INSPIRE View service shall contain the INSPIRE metadata elements set out in the Metadata 
  Regulation **INS MD** as shown in Table 3.
  !!!
  ...
  Scenario: Requirements 11-29 should be tested
