#language:es
Característica: Requisito 48
	En otros casos (especificación de dimensiones) como para la especificación de tiempo y
	elevación, <wms:Dimension> debe usarse de acuerdo con **INS NS**.	
    !!!
	...
	Escenario: comprobar que cada wms:Dimension (si existe alguno) tiene los atributos name y untis
	Dado el documento de capabilities del servicio
	Y la URI para el prefijo wms es http://www.opengis.net/wms
	Entonces existe un atributo name en cada sección wms:Dimension
	Y existe un atributo units en cada sección wms:Dimension
