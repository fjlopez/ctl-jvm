Feature: Requirement 23
	An extension shall be used to map this to an <inspire_common:Conformity> element 
	...
	Scenario: check if there has been correctly used inspire_common:Conformity element in case it was needed 
	...
	Then there is a inspire_common:Conformity node in the inspire_vs:ExtendedCapabilities section