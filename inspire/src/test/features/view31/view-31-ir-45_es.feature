#language:es
Característica: Requisito 45
  Debe existir una leyenda por cada estilo e idioma definido en el servicio de Visualización.
  !!!
  ...
  Escenario: Comprobar si cada estilo tiene una leyenda declarada en cada uno de los idiomas soportados
