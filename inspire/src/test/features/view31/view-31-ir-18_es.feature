...
Característica: Requisito 18
  Las palabras clave deben estar mapeadas utilizando la extensión del capabilities
  <inspire_common:Keyword> e <inspire_common:MandatoryKeyword> dentro del elemento
