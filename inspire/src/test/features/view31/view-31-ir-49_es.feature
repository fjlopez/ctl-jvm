#language:es
Característica: Requisito 49
  Una Capa de categoría incluye un nombre por el cual puede obtenerse un mapa con todas
  sus capas anidadas en una sola petición.  Si existe un metadato que contenga la descripción
  de esta capa, entonces deberá añadirse un elemento MetadataURL con una referencia a 
  este metadato.
  !!!
