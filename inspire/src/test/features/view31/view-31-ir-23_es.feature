...
Característica: Requisito 23
	Debe utilizarse una extensión para emparejar la conformidad con el elemento <inspire_common:Conformity> 
	dentro de <inspire_vs:ExtendedCapabilities>.
    !!!
	...
	Entonces existe un nodo inspire_common:Conformity en la sección inspire_vs:ExtendedCapabilities