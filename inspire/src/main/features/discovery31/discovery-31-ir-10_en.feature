...
Feature: Requirement 10
  The language parameter shall be implemented by using the Language queryable in a filter statement 
  as defined by **CSW ISO AP**. With that a client can request metadata records in a specific metadata 
  language.
  !!!
