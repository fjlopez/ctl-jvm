#language:es
Característica: Requisito 1
  Un Servicio de Visualización de INSPIRE debe implementar los requisitos mínimos de 
  comportamiento de un servicio **ISO 19128**, y además las extensiones requeridas
  por las reglas de implementación y la directiva de INSPIRE existentes para servicios
  de visualización.
  !!!
