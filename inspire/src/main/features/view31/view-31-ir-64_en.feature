Feature: Requirement 64
  Every time a map from a View Service is cascaded through another View Service the value of the
  “cascaded” attribute shall be incremented by 1. The actual collation of maps is out-of-scope for 
