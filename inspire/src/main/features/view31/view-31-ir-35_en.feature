Feature: Requirement 35
  Keywords shall be mapped to the <wms:KeywordList> element.
  !!!
  ...
  Scenario: Check if there is a KeywordList for each Layer
    Given the service's capabilities document
    And prefix wms is http://www.opengis.net/wms
    Then there is a wms:KeywordList node in each wms:Layer section
