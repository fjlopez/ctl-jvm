...
Característica: Requisito 25
  La organización responsable, tal y como se describe en la Regulación de Metadatos de INSPIRE **INS MD** debe ser
  emparejada con el elemento <wms:ContactOrganization> de la sección <wms:ContactPersonPrimary> dentro del elemento
