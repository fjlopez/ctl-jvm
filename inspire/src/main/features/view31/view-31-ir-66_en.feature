Feature: Requirement 66
  ...
  Scenario: Check if languages declared in ExtendedCapabilities sections are valid values within INSPIRE Scope
    Given the service's capabilities document
    Then languages declared in ExtendedCapabilities are INSPIRE recognized languages
