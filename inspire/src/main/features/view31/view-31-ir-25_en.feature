Feature: Requirement 25
  Responsible Party as described in the INSPIRE Metadata Regulation **INS MD** shall be mapped to the 
  <wms:ContactOrganization> element of the <wms:ContactPersonPrimary> within the <wms:ContactInformation> 
  element.
  !!!
