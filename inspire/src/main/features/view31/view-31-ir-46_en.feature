Feature: Requirement 46
	Style shall be mapped to the <wms:Style> element. The humanreadable name shall be mapped 
	to the <wms:Title> element and the Unique Identifier shall be mapped to the <wms:Name> 
	element.
    !!!
	...
	Scenario: Check if every Style has a Title 
