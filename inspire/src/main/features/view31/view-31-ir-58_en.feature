Feature: Requirement 58
  ...
  Scenario: Check if the use of parameter TRANSPARENT is admitted
    Given the service's capabilities document
    Then a request with transparent=TRUE should return an image
    And a request with transparent=FALSE should return an image
